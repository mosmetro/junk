...
void main()
{
   ...
   // gl_FragColor = col * 0.25 * vec4(var_color.rgb * var_color.a, 1.0);
   // gl_FragColor = col * 0.25 * vec4(var_color.rgb * var_color.a, var_color.a);
   gl_FragColor = col * 0.25 * var_color;
}
