...
local function pick_prev(seq)
   seq.next = seq.next and (seq.next - 1) or #seq
   return seq[seq.next % #seq + 1]
end -- pick_next
...
fastmath.INFINITY = 1 / 0
fastmath.VECTOR3_ZERO = vmath.vector3(0)
fastmath.VECTOR3_ONE  = vmath.vector3(1)
fastmath.VECTOR3_TWO  = vmath.vector3(2)
fastmath.QUAT_IDENTITY = vmath.quat()
fastmath.QUAT_Y_0 = vmath.quat_rotation_y(0)
fastmath.QUAT_Y_180 = vmath.quat_rotation_y(180 * TO_RAD)
fastmath.QUAT_Z_180 = vmath.quat_rotation_z(180 * TO_RAD)
fastmath.M4_IDENTITY = vmath.matrix4()
