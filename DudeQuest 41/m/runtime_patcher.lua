...
function pause()
   ...
   runtime.execute_in_context(global.pause_context.enable, global.pause_context)
   runtime.execute_in_context(global.backdrop_context.enable, global.backdrop_context)
end -- pause

function reset_input()
   -- utils.log("reset_input")
   for action_id, _ in next, current_state do
